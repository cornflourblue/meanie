...
!function(){"use strict";function e(e,t,a,n,i){function c(){g.loading=0,e._id?(g.loading+=1,n.GetById(e._id).then(function(e){g.loading-=1,g.page=e})):g.page={publish:!0}}function o(){n.Save(g.page).then(function(){i.Success("Page saved",!0),t.path("/pages")})["catch"](function(e){i.Error(e)})}function r(){n.Delete(g.page._id).then(function(){i.Success("Page deleted",!0),t.path("/pages")})["catch"](function(e){i.Error(e)})}var g=this;g.page={},g.savePage=o,g.deletePage=r,c()}e.$inject=["$stateParams","$location","$filter","PageService","AlertService"],angular.module("app").controller("Pages.AddEditController",e)}();
...
!function(){"use strict";function t(t,o,n,e){function s(){a.loading=0,t._id?(a.loading+=1,n.GetById(t._id).then(function(t){a.loading-=1,a.post=t})):a.post={publishDate:moment().startOf("day").utc().toISOString(),publish:!0}}function i(){n.Save(a.post).then(function(){e.Success("Post saved",!0),o.path("/posts")})["catch"](function(t){e.Error(t)})}function c(){n.Delete(a.post._id).then(function(){e.Success("Post deleted",!0),o.path("/posts")})["catch"](function(t){e.Error(t)})}var a=this;a.post={},a.savePost=i,a.deletePost=c,s()}t.$inject=["$stateParams","$location","PostService","AlertService"],angular.module("app").controller("Posts.AddEditController",t)}();
...
!function(){"use strict";function e(e,t,c,i,r){function n(){a.loading=0,e._id&&(a.loading+=1,i.GetById(e._id).then(function(e){a.loading-=1,a.redirect=e}))}function d(){i.Save(a.redirect).then(function(){r.Success("Redirect saved",!0),t.path("/redirects")})["catch"](function(e){r.Error(e)})}function o(){i.Delete(a.redirect._id).then(function(){r.Success("Redirect deleted",!0),t.path("/redirects")})["catch"](function(e){r.Error(e)})}var a=this;a.redirect={},a.saveRedirect=d,a.deleteRedirect=o,n()}e.$inject=["$stateParams","$location","$filter","RedirectService","AlertService"],angular.module("app").controller("Redirects.AddEditController",e)}();
!function(){"use strict";function e(e){function n(){t.loading=!0,e.GetAll().then(function(e){t.loading=!1,t.redirects=e})}var t=this;t.redirects=[],n()}e.$inject=["RedirectService"],angular.module("app").controller("Redirects.IndexController",e)}();
!function(){"use strict";function t(t){return{require:"ngModel",link:function(t,e,r,n){e.addClass("datepicker"),e.datepicker({dateFormat:"dd/mm/yy"}),n.$formatters.push(function(t){return t?moment(t).format("DD/MM/YYYY"):void 0}),n.$parsers.push(function(t){return t?moment(t,"DD/MM/YYYY").format("YYYY-MM-DD"):void 0})}}}t.$inject=["$filter"],angular.module("app").directive("datepicker",t)}();
...
!function(){"use strict";function n(){return function(n){return n?n.toString().replace(/,/g,", "):void 0}}angular.module("app").filter("csv",n)}();
...
!function(){"use strict";function t(t,e){function n(){return t.get(o).then(c,a)}function r(e){return t.get(o+"/"+e).then(c,a)}function u(e){return e._id?t.put(o+"/"+e._id,e).then(c,a):t.post(o,e).then(c,a)}function i(e){return t["delete"](o+"/"+e).then(c,a)}function c(t){return t.data}function a(t){return e.reject(t.data)}var o="/api/redirects",d={};return d.GetAll=n,d.GetById=r,d.Save=u,d.Delete=i,d}t.$inject=["$http","$q"],angular.module("app").factory("RedirectService",t)}();
