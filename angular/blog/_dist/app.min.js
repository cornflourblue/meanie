!function(){"use strict";function t(t,e,o){t.html5Mode(!0),o.otherwise("/"),e.state("home",{url:"/",templateUrl:"home/index.view.html",controller:"Home.IndexController",controllerAs:"vm"}).state("post-details",{url:"/post/:year/:month/:day/:slug",templateUrl:"posts/details.view.html",controller:"Posts.DetailsController",controllerAs:"vm"}).state("posts-for-tag",{url:"/posts/tag/:tag",templateUrl:"posts/tag.view.html",controller:"Posts.TagController",controllerAs:"vm"}).state("posts-for-month",{url:"/posts/:year/:month",templateUrl:"posts/month.view.html",controller:"Posts.MonthController",controllerAs:"vm"}).state("page-details",{url:"/page/:slug",templateUrl:"pages/details.view.html",controller:"Pages.DetailsController",controllerAs:"vm"})}function e(t){t.monthNames=["January","February","March","April","May","June","July","August","September","October","November","December"]}t.$inject=["$locationProvider","$stateProvider","$urlRouterProvider"],e.$inject=["$rootScope"],angular.module("app",["ui.router"]).config(t).run(e)}();
...
!function(){"use strict";function t(t,a,n,o){function r(){e.loading=0,e.loading+=1,o.GetAll().then(function(o){e.loading-=1,e.posts=_.filter(o,function(o){if(!o.tags)return!1;var r=!1;return _.each(o.tags,function(o){var i=a("slugify")(o);i===n.tag&&(e.tag=o,t.title="Posts tagged: "+e.tag,r=!0)}),r}),angular.forEach(e.posts,function(t){t.url="/post/"+a("date")(t.publishDate,"yyyy/MM/dd")+"/"+t.slug})})}var e=this;r()}t.$inject=["$rootScope","$filter","$stateParams","PostService"],angular.module("app").controller("Posts.TagController",t)}();
...
!function(){"use strict";function t(){return{scope:{},templateUrl:"/_directives/tag-list.html",controller:n,controllerAs:"vm"}}function n(t){function n(){t.GetAll().then(function(t){e.tags=_.chain(t).pluck("tags").flatten().uniq().sort().filter(function(t){return t}).value()})}var e=this;e.tags=[],n()}n.$inject=["PostService"],angular.module("app").directive("tagList",t)}();
