...
!function(){"use strict";function e(){return{link:function(e,i,n){i.datepicker()}}}angular.module("app").directive("datepicker",e)}();
...
!function(){"use strict";function t(t,o,n,e){function s(){t._id&&(a.loading=!0,n.GetById(t._id).then(function(t){a.loading=!1,a.post=t}))}function c(){n.Save(a.post).then(function(){e.Success("Post saved",!0),o.path("/posts")})["catch"](function(t){e.Error(t)})}function i(){n.Delete(a.post._id).then(function(){e.Success("Post deleted",!0),o.path("/posts")})["catch"](function(t){e.Error(t)})}var a=this;a.post={},a.savePost=c,a.deletePost=i,s()}t.$inject=["$stateParams","$location","PostService","AlertService"],angular.module("app").controller("Posts.AddEditController",t)}();
