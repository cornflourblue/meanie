!function(){"use strict";function t(t,o,e){e.otherwise("/"),o.state("home",{url:"/",templateUrl:"home/index.view.html",controller:"Home.IndexController",controllerAs:"vm",data:{activeTab:"home"}}).state("posts",{url:"/posts",templateUrl:"posts/index.view.html",controller:"Posts.IndexController",controllerAs:"vm",data:{activeTab:"posts"}}).state("posts-add",{url:"/posts/add",templateUrl:"posts/add-edit.view.html",controller:"Posts.AddEditController",controllerAs:"vm",data:{activeTab:"posts"}}).state("posts-edit",{url:"/posts/edit/:_id",templateUrl:"posts/add-edit.view.html",controller:"Posts.AddEditController",controllerAs:"vm",data:{activeTab:"posts"}}).state("account",{url:"/account",templateUrl:"account/index.view.html",controller:"Account.IndexController",controllerAs:"vm",data:{activeTab:"account"}})}function o(t,o,e){t.defaults.headers.common.Authorization="Bearer "+e.jwtToken,o.$on("$stateChangeSuccess",function(t,e,r,a,l){o.activeTab=e.data.activeTab})}t.$inject=["$locationProvider","$stateProvider","$urlRouterProvider"],o.$inject=["$http","$rootScope","$window"],angular.module("app",["ui.router"]).config(t).run(o),$(function(){$.get("/token",function(t){window.jwtToken=t,angular.bootstrap(document,["app"])})})}();
...
!function(){"use strict";function t(t){return{require:"ngModel",link:function(e,r,n,i){r.datepicker({dateFormat:"dd/mm/yy"}),i.$formatters.push(function(e){return e?t("date")(e,"dd/MM/yyyy"):void 0}),i.$parsers.push(function(t){return t?moment(t,"DD/MM/YYYY").format():void 0})}}}t.$inject=["$filter"],angular.module("app").directive("datepicker",t)}();
!function(){"use strict";function e(e){return{require:"ngModel",link:function(e,i,t,a){var n;n="minimal"===t.wysiwyg?{height:100,toolbar:[{name:"basic",items:["Bold","Italic","Underline"]},{name:"links",items:["Link","Unlink"]},{name:"tools",items:["Maximize"]},{name:"document",items:["Source"]}],removePlugins:"elementspath",resize_enabled:!1}:{filebrowserImageUploadUrl:"/api/files/upload",removeButtons:"About,Form,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,Save,CreateDiv,Language,BidiLtr,BidiRtl,Flash,Iframe,addFile,Styles"};var o=i.ckeditor(n);o.editor.on("change",function(){a.$setViewValue(this.getData())})}}}e.$inject=["$rootScope"],angular.module("app").directive("wysiwyg",e)}();
...
!function(){"use strict";function t(t,o,n,e,s){function i(){c.loading=0,t._id?(c.loading+=1,n.GetById(t._id).then(function(t){c.loading-=1,c.post=t,c.post.authorId&&(c.loading+=1,s.GetById(c.post.authorId).then(function(t){console.log("user",t),c.loading-=1,c.author=t}))})):(c.post={publishDate:moment().format(),publish:!0},c.loading+=1,s.GetCurrent().then(function(t){c.loading-=1,c.author=t,c.post.authorId=c.author._id}))}function a(){n.Save(c.post).then(function(){e.Success("Post saved",!0),o.path("/posts")})["catch"](function(t){e.Error(t)})}function r(){n.Delete(c.post._id).then(function(){e.Success("Post deleted",!0),o.path("/posts")})["catch"](function(t){e.Error(t)})}var c=this;c.post={},c.savePost=a,c.deletePost=r,i()}t.$inject=["$stateParams","$location","PostService","AlertService","UserService"],angular.module("app").controller("Posts.AddEditController",t)}();
