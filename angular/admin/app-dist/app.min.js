...
!function(){"use strict";function t(t,n,o){function e(){t._id&&(i.loading=!0,n.GetById(t._id).then(function(t){i.loading=!1,i.post=t}))}function c(){n.Save(i.post).then(function(){o.Success("Post saved")})["catch"](function(t){o.Error(t)})}function s(){n.Delete(i.post._id).then(function(){o.Success("Post deleted")})["catch"](function(t){o.Error(t)})}var i=this;i.post={},i.savePost=c,i.deletePost=s,e()}t.$inject=["$stateParams","PostService","FlashService"],angular.module("app").controller("Posts.AddEditController",t)}();
