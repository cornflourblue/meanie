...
"use strict";!function(){function e(t){var e={Success:function(e,a){t.globals.flash={message:e,type:"success",keepAfterLocationChange:a}},Error:function(e,a){t.globals.flash={message:e,type:"danger",keepAfterLocationChange:a}}};return t.$on("$locationChangeStart",function(){var e;(e=t.flash)&&(e.keepAfterLocationChange?e.keepAfterLocationChange=!1:delete t.flash)}),e}e.$inject=["$rootScope"],angular.module("app").factory("AlertService",e)}();
